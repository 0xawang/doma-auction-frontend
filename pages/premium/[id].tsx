...
export default function PremiumAuctionDetailPage() {
  ...
  const priceDecrement = auction?.priceDecrement
    ? formatEther(auction?.priceDecrement)
    : "0";
  const startPrice = auction?.startPrice
    ? formatEther(auction?.startPrice)
    : "0";
  const reservePrice = auction?.startPrice
  ...
  const currentPrice = (
    ...
    ((now - startTime) * parseFloat(priceDecrement)) / 60
  )?.toFixed(4);
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <Chip
                          color={
                            bettingPhase === "commit" ? "warning" : "primary"
                          }
                          size="sm"
                        >
                          {bettingPhase}
              ...
              <Card className="p-4">
                <CardHeader>
                  <h3 className="text-xl font-semibold">
                    4-Tier Price Betting Categories
                  </h3>
                </CardHeader>
                <CardBody>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="p-4 border border-red-200 rounded-lg bg-red-50">
                      <h4 className="font-semibold text-red-700">
                        Category 3: Above High
                      </h4>
                      <p className="text-sm text-red-600">
                        Final price &gte; {highPrice} ETH
                      </p>
                    </div>
                    <div className="p-4 border border-orange-200 rounded-lg bg-orange-50">
                      <h4 className="font-semibold text-orange-700">
                        Category 2: High~Low Range
                      </h4>
                      <p className="text-sm text-orange-600">
                        {lowPrice} ETH ≤ Final price ≤ {highPrice} ETH
                      </p>
                    </div>
                    <div className="p-4 border border-blue-200 rounded-lg bg-blue-50">
                      <h4 className="font-semibold text-blue-700">
                        Category 1: Below Low
                      </h4>
                      <p className="text-sm text-blue-600">
                        Final price &lte; {lowPrice} ETH
                      </p>
                    </div>
                    <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                      <h4 className="font-semibold text-gray-700">
                        Category 0: Uncleared
                      </h4>
                      <p className="text-sm text-gray-600">
                        Auction fails to clear
                      </p>
                    </div>
                  </div>
                </CardBody>
                ...
                <Tab key="auction" title="Place Bid">
                  <Card className="p-4">
                    <CardHeader className="flex flex-col items-start gap-1">
                      ...
                      <p className="text-sm text-gray-600">
                        First bid wins and ends auction
                      </p>
                    </CardHeader>
                ...
                <Tab key="betting" title="Place Bet">
                  <Card className="p-4">
                    <CardHeader className="flex flex-col items-start gap-1">
                      ...
                      <p className="text-sm text-gray-600">
                        Bet on final auction price category
                      </p>
                    </CardHeader>
                    <CardBody className="space-y-4">
                      <Select
                        ...
                        onSelectionChange={(keys) =>
                          setBetCategory(Array.from(keys)[0] as string)
                        }
                      >
                        <SelectItem key="3">
                          Category 3: Above High (&gte;{highPrice} ETH)
                        </SelectItem>
                        <SelectItem key="2">
                          Category 2: High~Low Range ({lowPrice}-{highPrice}{" "}
                          ETH)
                        </SelectItem>
                        <SelectItem key="1">
                          Category 1: Below Low (&lte;{lowPrice} ETH)
                        </SelectItem>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Progress
                        ...
                        size="sm"
                        value={
                          ((parseFloat(startPrice) - parseFloat(currentPrice)) /
                            parseFloat(startPrice)) *
                          100
                        }
                      />
